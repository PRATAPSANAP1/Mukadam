  ...
  return (
    <div className="space-y-8 animate-fade-in-up">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border-b-4 border-orange-500 group">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border-b-4 border-orange-400 group">
          <div className="flex items-center space-x-4">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border-b-4 border-red-500 group">
          <div className="flex items-center space-x-4">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border-b-4 border-green-500 group">
          <div className="flex items-center space-x-4">
